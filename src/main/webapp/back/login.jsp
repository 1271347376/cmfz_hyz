	...
	<script>
		...
		$(function(){
			...
			$("#captchaImage").click(function(){//点击更换验证码
                this.src='${pageContext.request.contextPath}/Code/code?'+Math.random();
			});
...
<body>
		...
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/admin/login" class="easyui-form"  method="post" >
				...
				<table>
					<tbody>
						<tr>
							...
							<td>
								<input type="text"  name="telphone" class="text"  maxlength="20"/>
							</td>
					  </tr>
					  <tr>
							<th>
					...
					<tr>
						...
						<th>&nbsp;</th>
						<td>
							<input type="button" class="homeButton" value="" onclick="location.href='/'"><input type="submit" id="loginButton" class="loginButton" value="登录">
						</td>
					</tr>
				</tbody></table>
