...
<div style="width:100%;text-align: center;">
    <form id="saveAlbumInputForm" class="easyui-form" method="post" enctype="multipart/form-data">
        ...
        <div style="margin-top: 20px;">
            专辑图片: <input  name="file"   class="easyui-filebox" data-options="required:true,width:165,height:26,">
        </div>
        <div style="margin-top: 20px;">
            星<span style="opacity: 0">一一</span>级: <input type="text" name="star" class="easyui-textbox" data-options="width:165,height:26,iconCls:'icon-man'">
        </div>
        <div style="margin-top: 20px;">
