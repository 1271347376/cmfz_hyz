...
<script>
    $(function(){
        $.get(
            "${pageContext.request.contextPath}/album/showOneAlbum?id=${param.id}",
            function(result){
...
<div style="width:100%;text-align: center;">
    <form id="saveChapterInputForm" class="easyui-form" method="post" enctype="multipart/form-data">
        ...
        <div style="margin-top: 20px;">
            章节大小: <input type="text" name="fileSize" class="easyui-textbox" data-options="width:165,height:26,iconCls:'icon-man'">
        </div>
        <div style="margin-top: 20px;">
            章节时长: <input type="text" name="duration" class="easyui-textbox" data-options="width:165,height:26,iconCls:'icon-man'">
        </div>
        <div style="margin-top: 20px;">
            章节路径: <input  name="file"  class="easyui-filebox" data-options="width:165,height:26,required:true,">
        </div>

        <div style="margin-top: 20px;">
            所属专辑: <select id="cc" name="album_id" style="width:160px;height:26px;">
                    </select>
        </div>
